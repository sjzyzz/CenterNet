...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--select_k', action='store_true', help='trim result by selecting top 20 score'
    )
    parser.add_argument('--exp_id', type=str, help='which model result to test')
    args = parser.parse_args()

    cocoGt = COCO('data/thu_basketball/annotations/test.json')
    resFile = f'exp/multi_class_pose/{args.exp_id}/results.json'
    new_resFile = f'exp/multi_class_pose/{args.exp_id}/K_results.json'
